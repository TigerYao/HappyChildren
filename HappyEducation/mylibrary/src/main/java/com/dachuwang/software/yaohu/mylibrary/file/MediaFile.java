...
public class MediaFile {
    ...
    public static final int FILE_TYPE_APK     = 44;
    public static final int FILE_TYPE_DOC     = 45;
    //静态内部类
    ...
    static {
        ...
        addFileType("PDF",FILE_TYPE_DOC,"application/pdf");
        addFileType("EXCEL",FILE_TYPE_DOC,"application/vnd.ms-excel");
        addFileType("PPT",FILE_TYPE_DOC,"application/vnd.ms-powerpoint");
