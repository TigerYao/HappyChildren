package com.cooki.tiger.childbook.widget;
...
public class DoublePagerView extends FrameLayout {
    ...
    public DoublePagerView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public DoublePagerView(Context context) {
        super(context);
        // TODO Auto-generated constructor stub
        mContext = context;
        viewInit();
    ...
    private class FingerTouchListener implements OnTouchListener {
        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            if (v == DoublePagerView.this && mAdapter != null) {
...
//						Log.d("DoublePagerView->DragToRight", "" + (currentPosition-1));
...
//						Log.d("DoublePagerView->", "" + (currentPosition+1));
                        nextView = mAdapter.getView(currentPosition+1, nextView, null);
                        nextViewTranscript = mAdapter.getView(currentPosition+1, nextViewTranscript, null);
                    }
                    isAnimated = false;
                    ...
                    DoublePagerView.this.postInvalidate();
